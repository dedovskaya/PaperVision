...
public class DataLoader : MonoBehaviour
{
    ...
    public void LoadCsvData()
    {
        ...
        GameObject nodesObj = GameObject.Find("Nodes");
        //nodesObj.transform.SetParent(graphObj.transform);

        GameObject edgesObj = GameObject.Find("Edges");
        ...
        for (int i = 1; i < lines.Length; i++)
        {
            ...
            if (values.Length > 1)
            {
                if (values[0] != "")
                {
                    ...
                    edge_props.cross_sectional_area = float.Parse(values[0]);
                    edge_props.diameter = float.Parse(values[1]);
                    edge_props.direct_length = float.Parse(values[2]);
                    edge_props.equivalent_diameter = float.Parse(values[3]);
                    edge_props.inscribed_diameter = float.Parse(values[4]);
                    edge_props.length = float.Parse(values[5]);
                    edge_props.perimeter = float.Parse(values[6]);
                    edge_props.total_length = float.Parse(values[7]);
                    edge_props.volume = float.Parse(values[8]);
                    edge_props.all = values[9]; //bool
                    edge_props.outer_outer = values[10];//bool
                    edge_props.outer_void = values[11];//bool
                    edge_props.void_outer = values[12];//bool
                    edge_props.void_void = values[13];//bool
                    ...
                    edge_props.phases0 = values[25]; //int
                    edge_props.phases1 = values[26]; //int
                ...
                if (values[27] != "")
                {
                    ...
                    node_props.phase = values[31]; //int
                    ...
                    node_props.all = values[36]; //bool
                    node_props.back = values[37]; //bool
                    node_props.front = values[38]; //bool
                    node_props.outer_space = values[39]; //bool
                    node_props.void_space = values[40]; //bool
